...
public class HelloController {
    ...
    private static final String URL = "aws-1-ca-central-1.pooler.supabase.com";
    private static final int PORT = 5432;
    private static final String DB = "postgres";
    private static final String USER = "postgres.qvczqichssyzqovtolnn";
    private static final String PASS = "Monmon2025";

    public HelloController() {
        String URL = "aws-1-ca-central-1.pooler.supabase.com";
        int PORT = 5432;
        String DB = "postgres";
        String USER = "postgres.qvczqichssyzqovtolnn";
        String PASS = "Monmon2025";
